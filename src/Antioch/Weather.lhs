...
> getWind :: Connection -> DateTime -> DateTime -> Maybe Float
> getWind conn now target = getWind' conn target (determineFType target now)

> getWind'               :: Connection -> DateTime -> Int -> Maybe Float
...
> getTAtm :: Connection -> DateTime -> DateTime -> Maybe Float
> getTAtm conn now target = getTAtm' conn target (determineFType target now)

> getTAtm' :: Connection -> DateTime -> Int -> Maybe Float
...
> getOpacity :: Connection -> DateTime -> DateTime -> Float -> Maybe Float
> getOpacity conn now target frequency = 
>     getOpacity' conn target (determineFType target now) frequency

> getOpacity' :: Connection -> DateTime -> Int -> Float -> Maybe Float
...
> getTSys :: Connection -> DateTime -> DateTime -> Float -> Maybe Float
> getTSys conn now target frequency = 
>     getTSys' conn target (determineFType target now) frequency

> getTSys' :: Connection -> DateTime -> Int -> Float -> Maybe Float
